...
public enum Word {
    ...
    NEXT, CANCEL, BACK, CREATE, NEWFLOORPLAN, PLANS, TYPE, ROWS, SEATSINROW, STAGE, EVENTS, SETDATE, SETTIME,
    MAXNROFSEATS, DATEFORMAT, TIMEFORMAT;
    ...
    private static HashMap<Word, String[]> createLanguages() {
        ...
        wordsMap.put(Word.NEXT, new String[]{"next", "järgmine", "tullõv",
                "neben", "todo"});
        wordsMap.put(Word.CANCEL, new String[]{"cancel", "tühista", "todo",
                "annullieren", "todo"});
        ...
        wordsMap.put(Word.PLANS, new String[]{"plan", "plaan", "plaan/kava",
                "Plan", "todo"});
        wordsMap.put(Word.TYPE, new String[]{"type", "tüüp", "sort",
                "Typ", "todo"});
        ...
        wordsMap.put(Word.DATEFORMAT, new String[]{"dd.mm.yyyy", "pp.kk.aaaa", "pp.kk.aaaa",
                "tt.mm.jj??", "todo"});
        wordsMap.put(Word.TIMEFORMAT, new String[]{"hh:mm", "hh:mm?", "tt:mm?",
                "ss:mm??", "todo"});
        return wordsMap;
    }
