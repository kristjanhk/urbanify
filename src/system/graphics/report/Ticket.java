...
public class Ticket extends GridPane {
    ...
    public Ticket(String ticketname, ArrayList<Double> ticketdata, Event event) {
        ...
        this.initChildren(ticketname, ticketdata, event);
    }

    private void initChildren(String ticketname, ArrayList<Double> ticketdata, Event event) {
        ...
        Text cost = new Text(String.format("%.2f", ticketdata.get(0)) + " " + event.getCurrency());
        ...
        Text total = new Text(String.format("%.2f", ticketdata.get(0) * ticketdata.get(1)) + " " + event.getCurrency());
